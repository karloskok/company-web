...
window.theme.fn = {
    ...
    dynIntObsInit: function (selector, functionName, pluginDefaults) {
        ...
        $($el).each(function () {
            ...
            var mergedPluginDefaults = theme.fn.mergeOptions(
                pluginDefaults,
                opts
            );

            var intersectionObserverOptions = {
                rootMargin: theme.fn.getRootMargin(
                    functionName,
	...
	*/
    if (
        ...
        $(window).on("load", function () {
            setTimeout(function () {
                ...
                if (
                    $("a[href$='" + window.location.hash + "']").is(
                        "[data-hash-offset]"
                    )
                ) {
                    offset = parseInt(
    ...
    var $noticeTopBar = {
        ...
        events: function () {
            ...
            self.$closeBtn.on("click", function (e) {
                ...
                if (
                    ["absolute", "fixed"].includes(self.$header.css("position"))
                ) {
                    self.$header.animate(
                        {
                            top: 0,
    ...
    if ($(".progress-reading").length) {
        function updateScrollProgress() {
            ...
            $(".progress-reading .progress-bar").width(
                parseInt(progress) + "%"
            );
        }
    ...
    $(".thumb-info-floating-caption").each(function () {
        ...
        if ($(this).hasClass("thumb-info-floating-caption-clean")) {
            $(".thumb-info-floating-element", $(this)).addClass(
                "bg-transparent"
            );
        }
    });
        ...
        if ($(window).width() < 1950) {
            $(".shape-divider svg[preserveAspectRatio]").each(function () {
                if (
                    !$(this)
                        .parent()
                        .hasClass("shape-divider-horizontal-animation")
                ) {
        ...
        var $footerReveal = {
            ...
            build: function () {
                var self = this,
                    ...
                    window_height =
                        $(window).height() - $(".header-body").height();
    ...
    PluginAnimate.prototype = {
        ...
        build: function () {
            ...
            if (self.options.flagClassOnly) {
                var delay = self.options.wrapper.attr(
            ...
            if ($("[data-carousel-navigate]").get(0)) {
                $('[data-carousel-navigate-id="#' + $el.attr("id") + '"]').each(
                    function () {
                        var $this = $(this),
                            hasCarousel = $(
                                $this.data("carousel-navigate-id")
                            ).get(0),
...
(function (theme, $) {
    ...
    PluginCarousel.prototype = {
        ...
        build: function () {
            ...
            $el.owlCarousel(this.options).addClass(
                "owl-carousel-init animated fadeIn"
            );
            ...
            if (self.options.animateIn || self.options.animateOut) {
                $el.on("change.owl.carousel", function (event) {
                    ...
                    // Animated Letters
                    $el.find("[data-plugin-animated-letters]").trigger(
                        "animated.letters.destroy"
                    );
        ...
        navigationOffsets: function () {
            var self = this,
                $el = this.options.wrapper,
                navHasTransform =
                    $el.find(".owl-nav").css("transform") == "none"
                        ? false
                        : true,
                dotsHasTransform =
                    $el.find(".owl-dots").css("transform") == "none"
                        ? false
                        : true;
...
(function (theme, $) {
    ...
    PluginFloatElement.prototype = {
        ...
        movement: function (minus) {
            ...
            var scrollPercent =
                (factor * currentElementOffset) / $window.height();
            ...
            if ($.cookie("porto-gdpr-preferences")) {
                ...
                for (var i = 0; i < preferencesArr.length; i++) {
                    if ($('input[value="' + preferencesArr[i] + '"]').get(0)) {
                        if (
                            $('input[value="' + preferencesArr[i] + '"]').is(
                                ":checkbox"
                            )
                        ) {
    ...
    PluginGDPRWrapper.prototype = {
        ...
        build: function () {
            ...
            if (
                ...
                $.cookie("porto-gdpr-preferences").indexOf(
                    self.options.checkCookie
                ) != -1
            ) {
                $.ajax({
                ...
                success: function (data, status, xhr) {
                    ...
                    if (self.options.removeClassAfterInit) {
                        iconWrapper.removeClass(
                            self.options.removeClassAfterInit
                        );
                    }
            ...
            if (!this.$overlay.closest(document.documentElement).get(0)) {
                if (!this.$cachedOverlay) {
                    switch (_self.options.effect) {
                        ...
                        case "cubes":
                            this.$overlay = $(
                                loadingOverlayCubesTemplate
                            ).clone();
                            break;

                        case "cubeProgress":
                            this.$overlay = $(
                                loadingOverlayCubeProgressTemplate
                            ).clone();
                            break;

                        case "floatRings":
                            this.$overlay = $(
                                loadingOverlayFloatRingsTemplate
                            ).clone();
                            break;

                        case "floatBars":
                            this.$overlay = $(
                                loadingOverlayFloatBarsTemplate
                            ).clone();
                            break;

                        case "speedingWheel":
                            this.$overlay = $(
                                loadingOverlaySpeedingWheelTemplate
                            ).clone();
                            break;

                        case "zenith":
                            this.$overlay = $(
                                loadingOverlayZenithTemplate
                            ).clone();
                            break;

                        case "spinningSquare":
                            this.$overlay = $(
                                loadingOverlaySpinningSquareTemplate
                            ).clone();
                            break;

                        case "pulse":
                            this.$overlay = $(
                                loadingOverlayPulseTemplate
                            ).clone();
                            break;
        ...
        updateProgress: function () {
            ...
            var render = function () {
                if (_self.pageStatus == "complete") {
                    ...
                    if (
                        ["percentageProgress2"].includes(_self.options.effect)
                    ) {
                        $(".loading-overlay-background-layer").css({
        ...
        build: function () {
            ...
            if (self.options.mouseParallax) {
                $window.mousemove(function (e) {
                    $(".parallax-mouse-object", self.options.wrapper).each(
                        function () {
            ...
            if (
                ...
                if ($scrollableWrapper.get(0)) {
                    var progress =
                            $(window).scrollTop() >
                            self.options.wrapper.offset().top +
                                $(window).outerHeight()
                    ...
                    $scrollableWrapper.css({
                        "background-image":
                            "url(" +
                            self.options.wrapper.data("image-src") +
                            ")",
                    ...
                    $(window).on("scroll", function (e) {
                        if (self.options.wrapper.visible(true)) {
                            ...
                            if (
                                ...
                                progress =
                                    self.options.cssValueStart + scrollPercent;
                            }
                            ...
                            var styles = {};
                            styles[self.options.cssProperty] =
                                progress + cssValueUnit;
    ...
    PluginRandomImages.prototype = {
        ...
        build: function () {
            ...
            if (self.$el.is("img")) {
                ...
                if (
                    self.isInsideLightbox &&
                    self.options.lightboxImagesListURL
                ) {
            ...
            setTimeout(function () {
                ...
                if (
                    ...
                    self.$el
                        ...
                        .attr(
                            "href",
                            self.options.lightboxImagesListURL[index]
                        );
                }
            }, 1000);
        ...
        perWrapper: function () {
            ...
            self.options.imagesListURL = self.shuffle(
                self.options.imagesListURL
            );
        ...
        recursiveTimeout: function (callback, delay) {
            ...
            var timeout = function () {
                ...
                if (
                    ...
                    parseInt(self.options.stopAtImageIndex) ==
                        self.perImageIndex
                ) {
                    clearTimeout(self.st);
                }
            ...
            for (var i = 0; i < sectionIDs.length; i++) {
                ...
                if ($(sectionIDs[i]).data("spy-offset")) {
                    var rootMarginOffset = $(sectionIDs[i]).data("spy-offset"),
                        isNegativeOffset =
                            parseInt(rootMarginOffset) < 0 ? true : false;
                ...
                var selector = sectionIDs[i],
                    callback = function () {
                        ...
                        if (target == "#header" || target == ".wrapper-spy") {
                            $("#header .header-nav .nav > li a").removeClass(
                                "active"
                            );
                            $(
                ...
                $(window).on(
                    ...
                    function (e) {
                        ...
                        var $currentSection = e.currentSection,
                            headerColor = $currentSection.data(
            ...
            if (self.options.wrapper.closest(".owl-carousel").get(0)) {
                self.options.wrapper
                    ...
                    .on("initialized.owl.carousel", function () {
                        ...
                        self.changePoster(
                            self.options.wrapper.closest(".owl-carousel")
                        );
                    });
            }

            // Play Video Button
            var $playButton = self.options.wrapper.find(
                        ...
                        if ($playWrapper.get(0)) {
                            $playWrapper.animate(
                                ...
                                function () {
                                    $playWrapper
                                        .parent()
                                        .height($playWrapper.outerHeight());
                                    $playWrapper.remove();
                                }
                            );
                        } else {
                ...
                function toggleFocus() {
                    ...
                    while (-1 === self.className.indexOf("header-nav-main")) {
                        ...
                        if ("li" === self.tagName.toLowerCase()) {
                            if (
                                -1 !==
                                self.className.indexOf("accessibility-open")
                            ) {
            ...
            events: function () {
                    ...
                    .on("click", function (e) {
                        ...
                        if ($window.width() > 991) {
                            ...
                            if (!$(this).closest("li").hasClass("open")) {
                                ...
                                if ($(this).prop("tagName") == "I") {
                                    $("#header .dropdown.open").removeClass(
                                        "open"
                                    );
                                    $(
                ...
                if ($(".side-panel-toggle").length) {
                    ...
                    $(document).on("click", function (e) {
                        if (
                            !$(e.target).closest(".side-panel-wrapper")
                                .length &&
        ...
        Search: {
            ...
            build: function () {
                ...
                theme.fn.execOnceTroughEvent(
                    ...
                    function () {
                        $(".header-nav-features-search-reveal").each(
                            function () {
                                var $el = $(this),
                                    $header = $("#header"),
                                    $html = $("html");
            ...
            build: function () {
                ...
                self.checkStickyHeader = function () {
                    ...
                    if ($noticeTopBar.get(0)) {
                        self.options.stickyStartAt = $noticeTopBar.data(
                            "sticky-start-at"
                        )
